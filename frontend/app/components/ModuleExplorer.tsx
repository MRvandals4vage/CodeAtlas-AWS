      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "14px" }}>
        {modules.map((mod: any, i: number) => (
          <div key={i} style={{
            ...
            boxShadow: expanded[mod.name] ? "0 10px 30px rgba(0,0,0,0.2)" : "none"
          }}>
            <div 
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: "16px", fontWeight: 700, display: "flex", alignItems: "center", gap: "10px" }}>
                  ...
                  <span style={{ fontSize: "11px", fontWeight: 500, color: "var(--text-muted)", background: "var(--bg-tertiary)", padding: "2px 8px", borderRadius: "4px" }}>
                    {mod.file_count || mod.files?.length || 0} files
                  </span>
                </div>
              ...
              {expanded[mod.name] ? <ChevronDown size={20} color="var(--text-muted)" /> : <ChevronRight size={20} color="var(--text-muted)" />}
            </div>
